...
In October 2023, the declaration of the contract in the Starknet mainnet block-chain costs about 85 US$, and the deployment of one kb cost about 1100 US$ ! So, only for high value data.  
